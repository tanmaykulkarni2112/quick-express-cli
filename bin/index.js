...
import { basicTemplateTS } from "./templates/basicTemplateTS.js";
import { serverCode2TS, routerCode2TS } from "./templates/router.templateTS.js";
import {
  routerCode3TS,
  controllerCode3TS,
} from "./templates/routerController.templateTS.js";
  ...
  if (!fs.existsSync(packageJsonPath)) {
    ...
    const pkgJson = {
      ...
      scripts: useTypeScript ? {
        start: "node --loader ts-node/esm server.template.ts",
        dev: "node --loader ts-node/esm --watch server.template.ts",
        build: "tsc",
